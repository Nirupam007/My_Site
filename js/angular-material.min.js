...
function() {
    ...
    angular.module("material.core").config(["$provide",
        function(t) {
...
function() {
    "use strict";
    var e = ["0", "0", "0"];
    angular.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$window", "$mdConstant",
        function(t, n, r, o, a, i) {
            ...
            return d = {
                ...
                getClosest: function(e, t) {
                    t = t.toUpperCase();
                    do
                        if (e.nodeName === t) return e; while (e = e.parentNode);
                    return null
                }
            }
        }
    ...
    function e(e, t, n) {
        ...
        function c(e, t) {
            ...
            var o = e.hasChildNodes(),
                a = !1;
            if (o)
                for (var i = e.childNodes, c = 0; c < i.length; c++) {
                    var d = i[c];
    ...
    function e(e, t, n, r, o, a) {
        this.compile = function(i) {
            var c = i.templateUrl,
                ...
                l = i.controller,
                s = i.controllerAs,
                m = i.resolve || {}, u = i.locals || {}, f = i.transformTemplate || angular.identity,
                p = i.bindToController;
            return angular.forEach(m, function(e, t) {
                m[t] = angular.isString(e) ? n.get(e) : n.invoke(e)
            }), angular.extend(m, u), m.$template = c ? t.get(c, {
                cache: a
            }).then(function(e) {
                return e.data
...
function() {
    ...
    var d, l = "mousedown touchstart pointerdown",
        s = "mousemove touchmove pointermove",
    ...
    var u = navigator.userAgent || navigator.vendor || window.opera,
        f = u.match(/iPad/i) || u.match(/iPhone/i) || u.match(/iPod/i),
        p = u.match(/Android/i),
        h = f || p;
    ...
    var g, b;
    angular.module("material.core").run(["$mdGesture",
        function() {}
    ]).factory("$mdGesture", ["$$MdGestureHandler", "$$rAF", "$timeout",
        function(e, t, n) {
            function r(t, n) {
                var r = new e(t);
        ...
        return r = {
            ...
            get: function(e) {
                ...
                for (t = 0, r = o.length; r > t; t++)
                    if (a = o[t], a.$$mdHandle === e) return a;
                return null
            },
...
function() {
    ...
    function t(e, t) {
        ...
        function a(n, r, o) {
            ...
            function c(e, n) {
                g.splice(g.indexOf(e), 1), 0 === g.length && a().css({
                    backgroundColor: ""
                }), t(function() {
                    e.remove()
                }, n, !1)
            ...
            function l(n, c) {
                ...
                function s(e, t) {
                    var n, r, a, i = u.prop("offsetWidth"),
                        c = u.prop("offsetHeight");
            ...
            var f, p = r.controller("mdInkRipple") || {}, h = 0,
                g = [],
                b = [],
                v = r.attr("md-highlight"),
                E = !1,
                $ = !1,
                M = r[0],
                A = r.attr("md-ripple-size"),
                T = i(r.attr("md-ink-ripple")) || i(e.getComputedStyle(o.colorElement[0]).color || "rgb(0, 0, 0)");
            switch (A) {
                case "full":
                    o.isFAB = !0;
...
function() {
                ...
                if (e = 0 === arguments.length ? !0 : !! e, e !== n.isDark) {
                    ...
                    return angular.forEach(t, function(e, t) {
                        var o = n.colors[t],
                            a = r[t];
                        if (o)
                            for (var i in o.hues) o.hues[i] === a[i] && (o.hues[i] = e[i])
                    }), n
                }
            }
            var n = this;
    ...
    function r(e, t, n) {
        ...
        var r = [],
            ...
            l = new RegExp("('|\")?{{\\s*(" + t + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"),
            s = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?\s*\}\}'?"?/g,
            m = d[o.name];
    ...
    function o(e) {
        ...
        o.forEach(function(e) {
            for (var t, n = (e.match(c), 0); t = E[n]; n++)
            ...
            function p(e, a) {
                ...
                function l(r) {
                    if (r.pointer.distanceY > 0 && (r.pointer.distanceY > 20 || Math.abs(r.pointer.velocityY) > n)) {
                        var a = e.prop("offsetHeight") - r.pointer.distanceY,
                            i = Math.min(a / r.pointer.velocityY * .75, 500);
                        e.css(t.CSS.TRANSITION_DURATION, i + "ms"), o(d.cancel)
                    } else e.css(t.CSS.TRANSITION_DURATION, ""), e.css(t.CSS.TRANSFORM, "")
                }
                var s = m.register(a, "drag", {
                    horizontal: !1
                });
        ...
        function n(e, t, n, r, o, a, i, c, d, l, s, m) {
            function u(n, o, i) {
                ...
                if (p(o.find("md-dialog")), i.hasBackdrop) {
                    var u = i.parent[0] == a[0].body && a[0].documentElement && a[0].scrollTop ? angular.element(a[0].documentElement) : i.parent,
                        f = u.prop("scrollTop");
            ...
            function b(e, t) {
                if (t) {
                    var n = t[0].getBoundingClientRect(),
                        ...
                        o = Math.min(.5, n.width / r.width),
                        a = Math.min(.5, n.height / r.height);
        ...
        function a(t, a, i, c) {
            ...
            function m() {
                var e = p(),
                    ...
                    i = v(),
                    c = b(),
                    d = r(n, h(), p()).map(function(t, r) {
                        return {
                            grid: {
                                element: a,
                                style: f(n, r, c, o, i)
                            },
                            tiles: t.map(function(t, a) {
                                return {
                                    element: angular.element(e[a]),
                                    style: u(t.position, t.spans, n, r, c, o, i)
                                }
                            })
                        }
                    }).reflow().performance();
            ...
            var M = angular.bind(c, c.invalidateLayout),
                A = d();
            t.$on("$destroy", l);
            var T = e("{{ share }}% - ({{ gutter }} * {{ gutterShare }})"),
                w = e("calc(({{ unit }}) * {{ offset }} + {{ offset }} * {{ gutter }})"),
                k = e("calc(({{ unit }}) * {{ span }} + ({{ span }} - 1) * {{ gutter }})")
        }
        return {
            restrict: "E",
            controller: t,
    ...
    function n(e) {
        ...
        function r(e, t) {
            function n(t, n) {
                ...
                return o(i, t.col, t.row), c = i + t.col, {
                    col: i,
                    row: d
                }
            }
...
function() {
    ...
    function e(e, t, n) {
        ...
        function o(r, o, a) {
            ...
            t(o);
            var c = a.alt || r.fontIcon || r.svgIcon,
                d = a.$normalize(a.$attr.mdSvgIcon || a.$attr.mdSvgSrc || "");
...
function() {
    ...
    function n(e, t, n, r, o) {
        ...
        function(e) {
            return e = e || "", h[e] ? n.when(h[e].clone()) : g.test(e) ? d(e).then(a(e)) : (-1 == e.indexOf(":") && (e = "$default:" + e), i(e).
                catch (c).
                catch (l).
                catch (s).then(a(e)))
        }
...
function() {
    ...
    function r(e) {
        function t(t, n, r, o) {
            ...
            var i, c = o[0],
                d = o[1],
                l = angular.element('<div class="md-char-counter">');
...
function() {
    ...
    function e(e, t, n) {
        ...
        function o(e, r, o) {
            n(r);
            var d, l, s, m, u = r[0],
                f = u.querySelectorAll(".md-fill, .md-mask.md-full"),
                p = u.querySelectorAll(".md-fill.md-fix"),
                h = o.mdDiameter || 48,
                g = h / 48;
...
function() {
    ...
    function e(e, n, r) {
        ...
        function a(o, a, c) {
            r(a);
            var d = a[0].querySelector(".md-bar1").style,
                l = a[0].querySelector(".md-bar2").style,
    ...
    function e(e, t, n) {
        ...
        function i(t, n) {
            ...
            if (r.count()) {
                ...
                }, a = t[0].querySelector("md-radio-button.md-checked"),
                    i = r[0 > n ? "previous" : "next"](a, o) || r.first();
    ...
    function e(e, t, n, r, o) {
        function a(r, a) {
            ...
            function(n, r, a, i) {
                ...
                function l(e) {
                    var t = [32, 13, 38, 40]; - 1 != t.indexOf(e.keyCode) && (e.preventDefault(), s(e))
                }
        ...
        function r(e, r, o, a) {
            ...
            function d(n) {
                var r = t.getClosest(n.target, "md-option"),
                    o = r && angular.element(r).data("$mdOptionController");
                if (r && o) {
                    var a = l.hashGetter(o.value),
                        i = angular.isDefined(l.selected[a]);
                    e.$apply(function() {
        ...
        function t(e, t, o, c, d, l) {
            ...
            function u(e, a, d) {
                var l, s = a[0],
                    ...
                    M = p.scrollHeight > p.offsetHeight,
                    A = f.querySelector("md-option[selected]"),
                    T = f.getElementsByTagName("md-option"),
                    w = f.getElementsByTagName("md-optgroup");
...
function() {
    ...
    function e(e, t) {
        return function(n) {
            var r = "SideNav '" + n + "' is not available!",
                o = e.get(n);
...
function() {
    ...
    function e(e, t, n, r, o, a, i, c) {
        ...
        function l(n, d, l, s) {
            ...
            var R = l.ngDisabled && c(l.ngDisabled),
                P = R ? function() {
                    return R(n.$parent)
                } : angular.noop,
                j = angular.element(d[0].querySelector(".md-thumb")),
                L = angular.element(d[0].querySelector(".md-thumb-text")),
                F = j.parent(),
                B = angular.element(d[0].querySelector(".md-track-container")),
                q = angular.element(d[0].querySelector(".md-track-fill")),
                V = angular.element(d[0].querySelector(".md-track-ticks")),
                U = r.throttle(b, 5e3);
            ...
            b();
            var J = !1,
                et = angular.isDefined(l.mdDiscrete)
        }
        return {
            scope: {},
            require: "?ngModel",
    ...
    function e(e, t, n, r, o) {
        function a(e) {
            function n(e, t) {
                ...
                return f.items.push(n), m.parent().prepend(n.clone), u(),
                function() {
            ...
            function o() {
                ...
                for (var e, t = m.prop("scrollTop"), n = f.items.length - 1; n >= 0; n--)
                    if (t > f.items[n].top) {
                        e = f.items[n];
                        break
                    }
        ...
        function i() {
            ...
            for (var r = ["sticky", "-webkit-sticky"], o = 0; o < r.length; ++o)
                if (n.css({
                    position: r[o],
                    top: 0,
                    "z-index": 2
...
function() {
    ...
    function e(e, t, n, r, o, a, i, c) {
        function d(e, t) {
            ...
            function(e, t, d, l) {
                function s(n) {
                    p(e) || (n.stopPropagation(), t.addClass("md-dragging"), b = {
                        width: h.prop("offsetWidth")
                ...
                l = l || n.fakeNgModel();
                var p = a(d.ngDisabled),
                    h = angular.element(t[0].querySelector(".md-thumb-container")),
...
function() {
    ...
    function e(e, t, n, r, o, a, i, c, d) {
        function l(l, u, f) {
            ...
            function b() {
                function e() {
                    var e = "left" === M || "right" === M ? 2 * Math.sqrt(Math.pow(r.width, 2) + Math.pow(r.height / 2, 2)) : 2 * Math.sqrt(Math.pow(r.width / 2, 2) + Math.pow(r.height, 2)),
                        t = "left" === M ? {
                            left: 100,
                            top: 50
                        } : "right" === M ? {
                ...
                function n(e) {
                    return "left" === e ? {
                        ...
                        left: a.left + a.width / 2 - r.width / 2,
                        top: a.top + a.height + m
                    }
                }
                var r = o.offsetRect(u, T),
                    a = o.offsetRect(v, T),
                    i = n(M);
            ...
            a(u);
            for (var v = u.parent(), E = angular.element(u[0].getElementsByClassName("md-background")[0]), $ = angular.element(u[0].getElementsByClassName("md-content")[0]), M = f.mdDirection;
    ...
    function e(e, t, n, r, o) {
        ...
        function m() {
            if (!M.hidden) switch (M.matches.length) {
                ...
                case 1:
                    return M.messages.push({
                        display: "There is 1 match available."
                    });
                default:
                    return M.messages.push({
                        display: "There are " + M.matches.length + " matches available."
                    })
            }
        }
    ...
    function e(e, t, n) {
        ...
        var o = t.attr("md-highlight-text"),
            ...
            i = e.$watch(o, function(e) {
                var n = new RegExp("^" + r(e), "i"),
                    o = a.replace(n, '<span class="highlight">$&</span>');
                t.html(o)
            });
...
function() {
    ...
    function e(e, t) {
        function n(n, r, o, a) {
            var i = a.parent.$new(!1, a.parent),
                c = a.scope.$eval(o.mdAutocompleteListItem);
            i[c] = n.item, e(r.contents())(i), r.attr({
                role: "option",
                id: "item_" + t.nextUid()
            })
        }
        ...
        function t(t, r, o, a) {
            function i() {
                ...
                if (r.css("display", o ? "none" : "block"), !o && t.pagination && t.pagination.tabData) {
                    var a = d.getSelectedIndex(),
                        i = t.pagination.tabData.tabs[a] || {
                            left: 0,
                            right: 0,
                            width: 0
                        }, l = r.parent().prop("offsetWidth") - i.right,
                        s = ["md-transition-left", "md-transition-right", "md-no-transition"],
                        m = n > a ? 0 : a > n ? 1 : 2;
                    r.removeClass(s.join(" ")).addClass(s[m]).css({
                        left: i.left + "px",
                        right: l + "px"
                    }), n = a
                }
...
function() {
    ...
    function e(e, t, n, r, o, a) {
        function i(i, d, l, s) {
            ...
            function u(e) {
                var t = T.tabData,
                    n = Math.max(0, Math.min(t.pages.length - 1, T.page + e)),
                    r = t.pages[n][e > 0 ? "firstTabIndex" : "lastTabIndex"],
                    o = s.itemAt(r);
                A = !0, m(o)
            }
            ...
            function g(e) {
                function t() {
                    var e = 1 === m.length ? r : o,
                        t = Math.min(Math.floor(e / l), E.length),
                        n = Math.floor(e / t);
                    return a.css("width", n + "px"), g(!0)
                }
                var n, r = d.parent().prop("offsetWidth"),
                    o = r - c - 1,
                    a = angular.element(E),
                    i = 0,
                    l = 0,
                ...
                return a.css("max-width", ""), angular.forEach(E, function(e, t) {
                    var a = Math.min(o, e.offsetWidth),
                        c = {
                            element: e,
                            left: i,
                            width: a,
            ...
            var E = d[0].getElementsByTagName("md-tab"),
                $ = n.throttle(f),
                M = d.children(),
                A = !1,
                T = i.pagination = {
    ...
    function e(e, t, n, r, o) {
        function a(a, i) {
            ...
            return function(a, i, l, s) {
                ...
                }), m(), b(), e.attachTabBehavior(a, i, {
                    colorElement: E.inkBarElement
                }), E.add(v), a.$on("$destroy", function() {
                    E.remove(v)
...
function() {
    ...
    function e(e, t, n) {
        ...
        var g = (h.contentArea = angular.element(t[0].querySelector(".md-tabs-content")), h.inRange = p.inRange, h.indexOf = p.indexOf),
            b = h.itemAt = p.itemAt;
